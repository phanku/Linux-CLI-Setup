...
info[1]='openPorts'
value[1]='Lists all current listening ports'
info[2]='apacheRestart'
value[2]='Restarts Apache'
info[3]='followErrorLog'
value[3]='Tails the Apache error log with Less'
info[4]='watchSynFlood'
value[4]='Begins a watch for SYN flood'
